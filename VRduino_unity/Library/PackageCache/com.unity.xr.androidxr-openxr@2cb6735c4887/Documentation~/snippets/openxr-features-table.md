...
| [Application SpaceWarp](xref:openxr-spacewarp) (OpenXR) | Use SpaceWarp to help maintain high frame rates. | [Application SpaceWarp](xref:androidxr-openxr-spacewarp) (Android XR) |
| [Automatic viewport dynamic resolution](xref:openxr-automatic-dynamic-resolution) (OpenXR) | Maintain a stable frame rate and improve graphical performance. | No unique behavior |