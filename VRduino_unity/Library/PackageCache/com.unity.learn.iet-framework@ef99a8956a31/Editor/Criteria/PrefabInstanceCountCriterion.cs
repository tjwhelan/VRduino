...
namespace Unity.Tutorials.Core.Editor
{
    ...
    public class PrefabInstanceCountCriterion : Criterion
    {
        ...
        protected override bool EvaluateCompletion()
        {
            ...
            var matches = EditorFindObjectUtils.FindObjectsByType<GameObject>().Where(go => PrefabUtilityShim.GetCorrespondingObjectFromSource(go) == PrefabParent);
        ...
        {
            var prefabInstances = EditorFindObjectUtils.FindObjectsByType<GameObject>().Where(go => PrefabUtilityShim.GetCorrespondingObjectFromSource(go) == PrefabParent);
