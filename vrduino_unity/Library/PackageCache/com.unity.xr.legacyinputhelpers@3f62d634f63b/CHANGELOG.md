...
### Fixed
- Fixed static variable declarations to enable proper use of [Fast Enter Play Mode](https://docs.unity3d.com/Manual/domain-reloading.html).

## [3.0.0] - 2025-10-10

### Removed
- Removed `com.unity.modules.vr` dependency.
- Removed obsolete `CameraOffset.trackingSpace` property and `CameraOffset.trackingOriginMode` should be used instead.

### Changed
- Changed the minimum supported Unity editor version to 2022.3 LTS.
